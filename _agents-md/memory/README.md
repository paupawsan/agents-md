...
2. **Read [organization.md](organization.md)** for memory management rules
3. **Read [rag-guide.md](rag-guide.md)** for efficient memory retrieval
4. **Read [platform-support.md](platform-support.md)** for platform-specific setup
...
2. Adhere to organization rules in [organization.md](organization.md)
3. Use RAG strategies from [rag-guide.md](rag-guide.md)
4. Implement platform detection from [platform-support.md](platform-support.md)
